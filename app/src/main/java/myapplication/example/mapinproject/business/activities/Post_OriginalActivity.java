...
public class Post_OriginalActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void Pin_infoActivity() {
        Intent intent = new Intent(Post_OriginalActivity.this, Pin_infoActivity.class);
